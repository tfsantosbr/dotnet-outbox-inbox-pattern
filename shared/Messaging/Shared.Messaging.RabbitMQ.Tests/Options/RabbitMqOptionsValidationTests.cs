...
{
    [Fact]
    public void Validate_WhenExchangeAndQueueAreEmpty_ShouldThrowWithAllErrors()
    {
    ...
    {
        var options = new RabbitMqConsumerOptions { Queue = "my-queue" };
    ...
    {
        var options = new RabbitMqConsumerOptions { Exchange = "my-exchange" };
